...
type ContactsDocumentDataSlicesSlice = ContactFormSlice;
...
export interface AboutSliceDefaultPrimary {
  ...
  /**
   * Discription field in *About → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: about.default.primary.discription
...
export interface ContentIndexSliceDefaultPrimary {
  ...
  /**
   * Discription field in *ContentIndex → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.default.primary.discription
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  discription: prismic.RichTextField;
...
export interface ExperienceSliceDefaultPrimaryTitleItem {
  ...
  /**
   * Discription field in *Experience → Default → Primary → Title*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.title[].discription
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  discription: prismic.RichTextField;
